...
import cn.dfusion.mylibrary.interfaces.ViewPresenter;
...
public abstract class BaseViewBottomWindow<T, BV extends BaseView<T>> extends BaseBottomWindow
    ...
    public void initView() {// 必须调用
        ...
        llBaseViewBottomWindowContainer = findViewById(R.id.llBaseViewBottomWindowContainer);

        tvBaseViewBottomWindowReturn = findViewById(R.id.tvBaseViewBottomWindowReturn);
        tvBaseViewBottomWindowForward = findViewById(R.id.tvBaseViewBottomWindowForward);
    }
