...
import cn.dfusion.mylibrary.interfaces.ActivityPresenter;
import cn.dfusion.mylibrary.interfaces.OnBottomDragListener;
import cn.dfusion.mylibrary.manager.SystemBarTintManager;
import cn.dfusion.mylibrary.manager.ThreadManager;
...
public abstract class BaseActivity extends FragmentActivity implements ActivityPresenter, OnGestureListener {
    ...
    public void setContentView(int layoutResID) {
        ...
        tvBaseTitle = findViewById(R.id.tvBaseTitle);//绑定默认标题TextView
    }
     ...
     *
     * @param tvTitle 标题
     * @return TextView  返回tvTitle是为了可以写成一行，如 tvTitle = autoSetTitle((TextView) findViewById(titleResId));
     * @must 在UI线程中调用
     */
