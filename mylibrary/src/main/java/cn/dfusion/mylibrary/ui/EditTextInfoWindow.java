...
import cn.dfusion.mylibrary.base.BaseBottomWindow;
import cn.dfusion.mylibrary.util.CommonUtil;
import cn.dfusion.mylibrary.util.EditTextUtil;
...
public class EditTextInfoWindow extends BaseBottomWindow implements OnClickListener {
    ...
    public static Intent createIntent(Context context, String key, String value) {
        return createIntent(context, key, value, "cn.dfusion.mylibrary");
    }
    ...
    /**
     * @param context 上下文
     * @param type    类型，ContactUtil
     * @param key     初始化关键字
     * @param value   初始化值
     * @return Intent
     */
    public static Intent createIntent(Context context, int type, String key, String value) {
        return createIntent(context, type, key, value, "cn.dfusion.mylibrary");
    }
    ...
    public void initView() {//必须调用
        ...
        tvEditTextInfoPlace = findViewById(R.id.tvEditTextInfoPlace);
        tvEditTextInfoPlace.setVisibility(View.GONE);

        etEditTextInfo = findViewById(R.id.etEditTextInfo);
        ivEditTextInfoClear = findViewById(R.id.ivEditTextInfoClear);
        tvEditTextInfoRemind = findViewById(R.id.tvEditTextInfoRemind);
    }
    ...
    public static final int TYPE_PASSWORD = 200 + ContactUtil.TYPE_PASSWORD;
    ...
    public void initData() {//必须调用
        ...
        switch (intentType) {
            case TYPE_NICK:
                ...
                break;
            case TYPE_PASSWORD:
                etEditTextInfo.setInputType(InputType.TYPE_TEXT_VARIATION_PASSWORD);
                maxEms = 16;
                break;
            case TYPE_PHONE:
    ...
    public void initEvent() {//必须调用
        ...
        etEditTextInfo.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (!StringUtil.isNotEmpty(inputedString, true)) {
